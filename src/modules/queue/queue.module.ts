...
import { ORDER_QUEUE, ORDER_DLQ } from './queue.constants.js';
...
@Module({
  imports: [
    ...
    BullModule.registerQueue({ name: ORDER_QUEUE }, { name: ORDER_DLQ }),
  ],
  providers: [OrderProcessor, DlqProcessor, ReconciliationProcessor, QueueShutdownService],
  exports: [BullModule],
})
